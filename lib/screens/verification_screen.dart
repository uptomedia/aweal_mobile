...
class _VerificationScreenState extends State<VerificationScreen> {
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      var errorMsg = S.of(context).couldNotVerifyEmail;
  ...
  Future<void> _resend() async {
    ...
    try {
      ...
      var errorMsg = S.of(context).couldNotSendCode;
      CommonFunctions.showErrorDialog(errorMsg, context);
    }
    // setState(() {
    //   _isLoading = false;
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        const SizedBox(
                          ...
                          Text(
                          S.of(context).enterCodeFromYourEmail,
                          style: TextStyle(
                            fontSize: 22,
                        ...
                        const SizedBox(height: 10),
                          Text(
                        S.of(context).enterDigitVerificationCodeSendToYourEmail,
