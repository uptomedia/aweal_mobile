  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      if (user.emailVerification == 'enable') {
        ...
        CommonFunctions.showSuccessToast(S.of(context).signUpSuccessful);
      }
    } catch (error) {
      var errorMsg = S.of(context).couldNotRegister;
      // print(error);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        key: scaffoldKey,
        elevation: 0,
        iconTheme: const IconThemeData(color: kRedColor),
        backgroundColor: kBackgroundColor,
      ),
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: TextFormField(
                            ...
                            decoration:
                                getInputDecoration(S.of(context).firstName, Icons.person),
                        ...
                        Padding(
                          ...
                          child: TextFormField(
                            ...
                            validator: (input) => input!.length < 3
                                ? S.of(context).passwordIsTooShort
                                : null,
