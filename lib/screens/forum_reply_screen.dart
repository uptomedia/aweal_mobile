  ...
  Future<void> _reply() async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        CommonFunctions.showSuccessToast(S.of(context).replyPosted);
        activeQuestions.clear();
      }
    } catch (error) {
      // print(error);
      var errorMsg = S.of(context).couldNotPostReply;
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (responseData['status'] != 200) {
          ...
          CommonFunctions.showSuccessToast(S.of(context).replyHasBeenDeleted);
