...
class _FilterWidgetState extends State<FilterWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    catData.insert(
        ...
        Category(
            id: 0,
            title: S.of(context).allCategory,
            thumbnail: null,
    ...
    langData.insert(
        0, Language(id: 0, value: 'all', displayedValue: S.of(context).allLanguage));
    final allCategory =
        Provider.of<Categories>(context, listen: false).allItems;
    allCategory.insert(
        0, AllCategory(id: 0, title: S.of(context).allCategory, subCategory: data));
    return _isLoading
                  ...
                  children: [
                    ...
                    Image.asset(
                     ...
                     Padding(
                      ...
                      Padding(
                      padding: EdgeInsets.all(4.0),
                      child: Text(S.of(context).pleaseCheckYourInternetConnection ),
                    ),
                  ],
                ),
              )
                          ...
                          children: <Widget>[
                            ...
                            Card(
                             ...
                             Padding(
                              padding: EdgeInsets.symmetric(vertical: 5),
                              child: CustomText(
                                text: S.of(context).subCategories,
                                fontSize: 17,
                                colors: kTextColor,
                              ),
                            ),
                            Card(
                              ...
                              child: Padding(
                                ...
                                child: DropdownButton(
                                  ...
                                  isExpanded: true,
                                  hint:   Text(S.of(context).allSubCategory,
                                      style: TextStyle(
                                        color: kSecondaryColor,
                                        fontSize: 15,
                                      )),
