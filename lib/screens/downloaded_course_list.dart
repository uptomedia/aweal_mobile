...
import 'package:academy_app/screens/download_list_screen.dart';
...
class _DownloadedCourseListState extends State<DownloadedCourseList> {
  ...
  lessonCounter(courseId) {
    ...
    return CustomText(
      text:'${S.of(context).totalLessons}$count',
      fontSize: 12,
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        elevation: 0,
        title:   Text(S.of(context).downloadedCourse),
                  ...
                  child: Column(
                    children: [
                      ...
                      Image.asset(
                        ...
                        child: Text(
                          S.of(context).noLessonsDownloadedYet,
