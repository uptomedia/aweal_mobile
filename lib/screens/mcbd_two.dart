...
class McbdTwo extends StatefulWidget {
  static const routeName = '/my-bundle-course-details-two';
  final int bundleId;
  final int courseId;
  const McbdTwo({Key? key, required this.bundleId, required this.courseId})
      : super(key: key);

  @override
  State<McbdTwo> createState() => _McbdTwoState();
}

class _McbdTwoState extends State<McbdTwo> with SingleTickerProviderStateMixin {
  ...
  void _initDownload(
    ...
    if (lesson.videoTypeWeb == 'YouTube') {
      ...
      CommonFunctions.showSuccessToast(
          S.of(context).thsisVideoFormatIsNotSupportedForDownload );
    } else {
