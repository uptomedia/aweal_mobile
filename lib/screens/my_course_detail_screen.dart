  ...
  void _initDownload(
    ...
    if (lesson.videoTypeWeb == 'YouTube') {
      CommonFunctions.showSuccessToast(
          S.of(context).thisVideoFormatIsNotSupportedForDownload );
      ...
      if (les != true) {
        ...
        CommonFunctions.showSuccessToast(S.of(context).videoWasDownloadedAlready );
      }
    }
  }
                          ...
                          children: [
                            ...
                            PopupMenuButton(
                              ...
                              itemBuilder: (_) => [
                                 PopupMenuItem(
                                  value: 'details',
                                  child: Text(S.of(context).courseDetails ),
                                ),
                                  PopupMenuItem(
                                  value: 'share',
                                  child: Text(S.of(context).shareThisCourse ),
                                ),
                              ],
                            ),
                          ],
                                  ...
                                  child: Container(
                                    ...
                                    child: Align(
                                      ...
                                      child: Container(
                                        ...
                                        child: CustomText(
                                          text:
                                              '${section.mLesson!.length} ${S.of(context).lessons}',
                                          fontSize: 10,
                                          colors: kDarkGreyColor,
                                        ),
                                      ),
                                        ...
                                        if (indexLess != 0) {
                                          if (section.mLesson![indexLess - 1]
                                            ...
                                            CommonFunctions.showWarningToast(
                                                S.of(context).previousLessonsWasNotCompleted );
                                          } else {
                                            setState(() {
                                                          ...
                                                          ? Expanded(
                                                              ...
                                                              child: Checkbox(
                                                                  ...
                                                                  onChanged:
                                                                    ...
                                                                    CommonFunctions
                                                                        .showWarningToast(
                                                                        S.of(context).watchLessonsToUpdateCourseProgress);
                                                                  }),
                                                            )
                                                          : Expanded(
                                                              flex: 1,
                                                                    ...
                                                                    Provider.of<MyCourses>(
                                                                        ...
                                                                        .toggleLessonCompleted(
                                                                            ...
                                                                            value!
                                                                                ...
                                                                                : 0)
                                                                        .then((_) =>
                                                                            CommonFunctions.showSuccessToast(S.of(context).courseProgressUpdated ));
                                                                  }),
                                                            )
                                                      : section
                                                                  .mLesson![
                                                              ...
                                                              ? Expanded(
                                                                  ...
                                                                  child:
                                                                      Checkbox(
                                                                          ...
                                                                          onChanged:
                                                                              (bool? value) {
                                                                            CommonFunctions.showWarningToast(S.of(context).watchLessonsToUpdateCourseProgress );
                                                                          }),
                                                                )
                                                              : Expanded(
                                                                  flex: 1,
                                                    ...
                                                    onChanged: (bool? value) {
                                                      ...
                                                      Provider.of<MyCourses>(
                                                          ...
                                                          .then((_) => CommonFunctions
                                                              .showSuccessToast(
                                                          S.of(context).courseProgressUpdated ));
                                                    }),
                                              ),
                                              Expanded(
                                                flex: 8,
