...
const BASE_URL = 'https://awael-altawjehi.com'; // Example: const BASE_URL = 'http://192.168.0.119/academy-demo';

// const BASE_URL = 'https://vipethi opia.com';

// list of colors that we use in our app
const kBackgroundColor = Color(0xFFF5F9FA);
const kDarkButtonBg = Color(0xFF55154e);
const kSecondaryColor = Color(0xff5a2553);
const kSelectItemColor = Color(0xFF55154e);
const kRedColor = Color(0xFF55154e);
...
const kLightBlueColor = Color(0xFF55154e);
...
const iLongArrowRightColor = Color(0xFF55154e);
