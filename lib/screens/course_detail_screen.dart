                                  ...
                                  if (_authToken != null) {
                                    if (loadedCourse.isFreeCourse == '1') {
                                      ...
                                      Provider.of<Courses>(context,
                                          ...
                                          .then((_) =>
                                              CommonFunctions.showSuccessToast(
                                                  S.of(context).enrolledSuccessfully));
                                    } else {
                                      final url =
                      ...
                      SingleChildScrollView(
                        child: Column(
                          ...
                          children: <Widget>[
                            ...
                            //             children: [
                            //               TabViewDetails(
                            //                 titleText:S.of(context).whatIsIncluded,
                            //                 listText: loadedCourseDetail
                            //                     .courseIncludes,
                            //               ),
                            //               TabViewDetails(
                            //                 titleText: S.of(context).whatYouWillLearn,
                            //                 listText: loadedCourseDetail
                            //                     .courseOutcomes,
                            //               ),
                            //               TabViewDetails(
                            //                 titleText: S.of(context).courseRequirements,
                            //                 listText: loadedCourseDetail
                            //                     .courseRequirements,
                            //               ),
                            //             ],
                            ...
                            // ),
                             Padding(
                              ...
                              child: CustomText(
                                text: S.of(context).courseCurriculum,
                                fontSize: 20,
                                fontWeight: FontWeight.w400,
